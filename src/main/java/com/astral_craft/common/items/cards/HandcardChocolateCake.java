...
public class HandcardChocolateCake extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_chocolate_cake", CardType.EFFECT, CardTargetMode.SELF, -1, false));
