...
public class HandcardAllOrNothing extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_all_or_nothing", CardType.EFFECT, CardTargetMode.SELF, -1, false));
