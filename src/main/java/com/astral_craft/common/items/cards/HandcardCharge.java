...
public class HandcardCharge extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_charge", CardType.ATTACK, CardTargetMode.NONE, -1, false));
