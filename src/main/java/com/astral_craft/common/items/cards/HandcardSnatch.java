...
public class HandcardSnatch extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_snatch", CardType.EFFECT, CardTargetMode.ENEMY_PLAYER, 32, false));
