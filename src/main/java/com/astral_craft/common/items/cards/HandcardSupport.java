...
public class HandcardSupport extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_support", CardType.EFFECT, CardTargetMode.ANY_PLAYER, 32, false));
