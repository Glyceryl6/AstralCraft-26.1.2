...
public class HandcardFateGuidance extends BaseHandCard {

    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_fate_guidance", CardType.EFFECT, CardTargetMode.CHOICE, 6, false));
    ...
    protected boolean apply(ServerPlayer user, InteractionHand hand, List<LivingEntity> targets) {
        AstralCardEffects.update(user, AstralStats.get(user).setNextMoveFixed(6).addCardPlaysThisTurn(1));
        return true;
    }
