...
public class HandcardReleaseScarletSoul extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_release_scarlet_soul", CardType.EFFECT, CardTargetMode.MONSTER, 6, false));
