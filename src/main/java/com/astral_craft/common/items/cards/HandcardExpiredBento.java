...
public class HandcardExpiredBento extends BaseHandCard {
    
    public static final CardDefinition DEFINITION = CardDefinition.create("handcard_expired_bento", CardType.EFFECT, CardTargetMode.ANY_PLAYER, 6, false);
