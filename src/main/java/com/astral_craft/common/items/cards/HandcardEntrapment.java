...
public class HandcardEntrapment extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_entrapment", CardType.EFFECT, CardTargetMode.PANEL, 3, false));
