...
public class HandcardBarricade extends BaseHandCard {

    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_barricade", CardType.EFFECT, CardTargetMode.PANEL, 10, false));
