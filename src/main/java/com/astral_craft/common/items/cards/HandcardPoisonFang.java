...
public class HandcardPoisonFang extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_poison_fang", CardType.ATTACK, CardTargetMode.NONE, -1, true));
