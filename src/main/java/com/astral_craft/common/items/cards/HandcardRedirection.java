...
public class HandcardRedirection extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_redirection", CardType.EFFECT, CardTargetMode.CHOICE, -1, false));
