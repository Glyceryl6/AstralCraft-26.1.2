...
public class HandcardScavenging extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_scavenging", CardType.EFFECT, CardTargetMode.PANEL, 3, false));
