...
public class HandcardAshenFeather extends BaseHandCard {

    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_ashen_feather", CardType.JINX, CardTargetMode.PANEL, 5, false));
