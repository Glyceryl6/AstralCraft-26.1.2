...
public class HandcardMisfortune extends BaseHandCard {
    public static final CardDefinition DEFINITION = CardDefinition.create(CardType.EFFECT, CardTargetTypes.PLAYERS_AND_MOBS, 10).withRestrictions(new CardUseRestriction(List.of(AstralCraft.prefix("zhao")), true, true));
