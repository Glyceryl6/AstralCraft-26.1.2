...
public class HandcardBarrier extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_barrier", CardType.COUNTER, CardTargetMode.SELF, -1, false));
