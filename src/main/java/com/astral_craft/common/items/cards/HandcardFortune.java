...
public class HandcardFortune extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_fortune", CardType.EFFECT, CardTargetMode.ANY_PLAYER, 32, false));
