...
public class HandcardShadowAttack extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_shadow_attack", CardType.ATTACK, CardTargetMode.NONE, -1, true));
