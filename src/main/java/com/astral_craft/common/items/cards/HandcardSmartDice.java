...
public class HandcardSmartDice extends BaseHandCard {
    ...
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_smart_dice", CardType.EFFECT, CardTargetMode.CHOICE, 6, false));
    ...
    protected boolean apply(ServerPlayer user, InteractionHand hand, List<LivingEntity> targets) {
        AstralCardEffects.update(user, AstralStats.get(user).setNextMoveFixed(6));
        return true;
    }
