...
public class HandcardColourfulFeather extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_colourful_feather", CardType.EFFECT, CardTargetMode.PANEL, 5, false));
