...
public class HandcardRandomPortal extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_random_portal", CardType.EFFECT, CardTargetMode.NONE, -1, false));
