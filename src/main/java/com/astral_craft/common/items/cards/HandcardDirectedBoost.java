...
public class HandcardDirectedBoost extends BaseHandCard {

    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_directed_boost", CardType.EFFECT, CardTargetMode.CHOICE, -1, false));
