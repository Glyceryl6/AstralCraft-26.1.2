...
public class HandcardDefenseM extends BaseHandCard {
    public static final CardDefinition DEFINITION = AstralPartyCards.register(CardDefinition.create("handcard_defense_m", CardType.DEFENSE, CardTargetMode.NONE, -1, true));
