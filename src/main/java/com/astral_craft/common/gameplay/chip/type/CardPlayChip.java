...
public class CardPlayChip extends ChipDefinition {

    private final int amount;

    public CardPlayChip(Identifier id, ChipRarity rarity, int amount) {
    ...
    protected AstralPlayerStats applyStats(AstralPlayerStats stats) {
        return stats.addCardPlaysPerTurn(this.amount);
    }
}
