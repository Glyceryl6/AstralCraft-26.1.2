...
public class AstralItems {
    ...
    public static final DeferredHolder<Item, ? extends Item> EXHIBITION_CHARACTER_TOOL = register("exhibition_character_tool", ExhibitionCharacterToolItem::new, () -> new Item.Properties().stacksTo(1));
