...
public class AstralEventBootstrap {
    ...
    public static List<AstralEventDefinition> builtins() {
        return List.of(luckyFind(), ambush(), astralBlessing(), lowHealthAid(), nightAmbush(), caveCache());
    }

    public static ResourceKey<AstralEventDefinition> key(String path) {
        return ResourceKey.create(AstralDataPackRegistryKeys.EVENTS, AstralCraft.prefix(path));
    }

    public static AstralEventDefinition luckyFind() {
        return event("lucky_find", "good", List.of("block_break"), List.of(), AstralEventTargetDefinition.DEFAULT, AstralEventTriggerSettings.DEFAULT,
                List.of(new GiveItemEventEffect(Identifier.parse("minecraft:emerald"), 1)), List.of(), List.of(), List.of(), 600, 0.2D, "instant", 0, 20);
    }
    ...
    public static AstralEventDefinition lowHealthAid() {
        return event("low_health_aid", "good", List.of("player_hurt", "entity_hurt_player"), List.of(new HealthEventCondition(0.0F, Float.MAX_VALUE, 0.35F)), AstralEventTargetDefinition.DEFAULT,
    ...
    public static AstralEventDefinition caveCache() {
        return event("cave_cache", "good", List.of("block_break"), List.of(new PositionEventCondition(Integer.MIN_VALUE, 40, 0, 0, -1)), AstralEventTargetDefinition.DEFAULT,
                new AstralEventTriggerSettings("cooldown", "", 1200, 0, true),
                List.of(new AddExperienceEventEffect(5), new ChanceEventEffect(0.5D, new GiveItemEventEffect(Identifier.parse("minecraft:iron_nugget"), 3))),
