...
import com.astral_craft.common.gameplay.event.conditions.ManualEventCondition;
...
public class AstralEventConditionTypes {
    ...
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<TickEventCondition>> TICK = register("tick", TickEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<ManualEventCondition>> MANUAL = register("manual", ManualEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<BlockBreakEventCondition>> BLOCK_BREAK = register("block_break", BlockBreakEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<PlayerHurtEventCondition>> PLAYER_HURT = register("player_hurt", PlayerHurtEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<EntityHurtPlayerEventCondition>> ENTITY_HURT_PLAYER = register("entity_hurt_player", EntityHurtPlayerEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<PlayerHurtEntityEventCondition>> PLAYER_HURT_ENTITY = register("player_hurt_entity", PlayerHurtEntityEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<PlayerKilledEventCondition>> PLAYER_KILLED = register("player_killed", PlayerKilledEventCondition.CODEC);
    public static final DeferredHolder<MapCodec<? extends AstralEventCondition>, MapCodec<PlayerKilledEntityEventCondition>> PLAYER_KILLED_ENTITY = register("player_killed_entity", PlayerKilledEntityEventCondition.CODEC);
