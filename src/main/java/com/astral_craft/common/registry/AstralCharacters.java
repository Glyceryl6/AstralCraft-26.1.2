...
public class AstralCharacters {
    ...
    public static final DeferredHolder<AstralCharacter, AstralCharacter> PADMAN = register("padman", properties(2, 2, 9).chipWeights(15, 15, 100, 15).cooldown(3), progression(14));
    ...
    public static final DeferredHolder<AstralCharacter, AstralCharacter> Z3000 = register("z3000", properties(1, 2, 10).chipWeights(15, 15, 100, 30).cooldown(3, 4), progression(18));
    public static final DeferredHolder<AstralCharacter, AstralCharacter> PANDAMAN = register("pandaman", properties(1, 0, 14).chipWeights(60, 60, 15, 15).cooldown(4, 3), progression(19));
    ...
    public static final DeferredHolder<AstralCharacter, AstralCharacter> AL = register("al", properties(1, 1, 9).chipWeights(80, 15, 15, 30).cooldown(3, 3), progression(26));
