...
public record BoardCharacterSelectionPayload(String boardId, String characterId, String skinId) implements CustomPacketPayload {
    ...
    public static final StreamCodec<ByteBuf, BoardCharacterSelectionPayload> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.STRING_UTF8, BoardCharacterSelectionPayload::characterId,
            ByteBufCodecs.STRING_UTF8, BoardCharacterSelectionPayload::skinId,
