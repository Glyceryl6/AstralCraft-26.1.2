...
public class AstralCharacterDataCatalog {
    ...
    public static final List<CharacterEntry> CHARACTERS = List.of(
            character("parunan").setEnName("Parunan").setZhName("帕露南").setEnTitle("Lord of Commerce").setZhTitle("商业之主")
                    .setAttack(1).setDefense(2).setHealth(10).setUnlockedByDefault(true).setSkillSameIn2Mode(true).setSortOrder(10).setCooldown(2)
                    .setSkins(skin("fashion_icon", "Fashion Icon", "时尚达人", "sapphire"),
                            skin("fortune_guardian", "Fortune Guardian", "善财天宫", "amethyst")),
            character("fanny").setEnName("Fanny").setZhName("芬妮").setEnTitle("Quirky Detective").setZhTitle("古怪神探")
                    .setAttack(1).setDefense(2).setHealth(10).setUnlockedByDefault(true).setSkillSameIn2Mode(true).setSortOrder(11).setCooldown(3)
            ...
            character("alana").setEnName("Alana").setZhName("阿兰娜").setEnTitle("Shy Nun").setZhTitle("社恐修女")
                    .setAttack(1).setDefense(1).setHealth(9).setUnlockedByDefault(true).setSkillSameIn2Mode(true).setSortOrder(12).setCooldown(3)
            ...
            character("komachi").setEnName("Komachi").setZhName("小町").setEnTitle("Shadow Ninja").setZhTitle("暗影忍者")
                    .setAttack(1).setDefense(1).setHealth(9).setUnlockedByDefault(true).setSkillSameIn2Mode(true).setSortOrder(13).setCooldown(3)
                    .setSkins(skin("why_the_ninja", "Why the Ninja?", "忍者为何？", "sapphire"),
                            skin("shadow_spirit", "Shadow Spirit", "暗影狼灵", "amethyst")),
            character("padman").setEnName("Padman").setZhName("派德曼").setEnTitle("Uncle Employee").setZhTitle("社员叔叔")
                    .setAttack(2).setDefense(2).setHealth(9).setSkillSameIn2Mode(true).setSortOrder(14).setCooldown(3),
            character("papara").setEnName("Papara").setSkillSameIn2Mode(true).setZhName("帕帕拉").setEnTitle("Red Hot").setZhTitle("猩红辣妹")
                    .setAttack(2).setDefense(1).setHealth(10).setSortOrder(15).setCooldown(3).setSkins(
                            skin("guard_captain", "Guard Captain", "护卫队长", "sapphire")),
            character("ren").setEnName("Ren").setZhName("恋").setEnTitle("Pro Gamer").setZhTitle("游戏大师")
                    .setAttack(2).setDefense(1).setHealth(8).setUnlockedByDefault(true).setSortOrder(16).setCooldown(3)
            ...
            character("lulu").setEnName("Lulu").setZhName("璐璐").setEnTitle("Slime Girl").setZhTitle("史莱姆")
                    .setAttack(2).setDefense(2).setHealth(9).setSortOrder(20).setCooldown(4,3)
            ...
            character("hai_qing").setEnName("Hai Qing").setZhName("蓝海晴").setEnTitle("Destiny Girl").setZhTitle("命运少女")
                    .setAttack(1).setDefense(1).setHealth(10).setSortOrder(22).setCooldown(3)
            ...
            character("misaki").setEnName("Misaki").setZhName("美咲").setEnTitle("Katana Master").setZhTitle("太刀使")
                    .setAttack(0).setDefense(2).setHealth(9).setSortOrder(23).setCooldown(3)
                    .setSkins(skin("maid_warrior", "Maid Warrior", "战斗女仆", "sapphire"),
            ...
            character("nardis").setEnName("Nardis").setZhName("娜蒂斯").setEnTitle("Oasis Queen").setZhTitle("绿洲女王")
                    .setAttack(1).setDefense(1).setHealth(9).setSkillSameIn2Mode(true).setSortOrder(24).setCooldown(3)
                    .setSkins(skin("twilight_witch", "Twilight Witch", "暮色魔女", "sapphire"),
                            skin("festival_dress", "Festival Dress", "祭典礼装", "amethyst")),
            character("jasmine").setEnName("Jasmine").setZhName("茉莉").setEnTitle("Robot Maid").setZhTitle("家政机器人")
                    .setAttack(1).setDefense(0).setHealth(9).setSkillSameIn2Mode(true).setSortOrder(25).setCooldown(4)
            ...
            character("al").setEnName("A.L.").setZhName("阿尔").setEnTitle("Syndicate Prince").setZhTitle("暗区少主")
                    .setAttack(1).setDefense(1).setHealth(9).setSortOrder(26).setCooldown(3)
            ...
            character("luka").setEnName("Luka").setZhName("星魅琉华").setEnTitle("Midnight Flash").setZhTitle("午夜闪光")
                    .setAttack(1).setDefense(2).setHealth(9).setSortOrder(27).setCooldown(3)
                    .setSkins(skin("special_gift", "Special Gift", "特别礼物", "sapphire"),
                            skin("fated_crossroads", "Fated Crossroads", "转角之期", "amethyst")),
            character("nancy_lu").setEnName("Nancy Lu").setZhName("南希露").setEnTitle("Cyber Phantom").setZhTitle("网络魅影")
                    .setAttack(1).setDefense(1).setHealth(9).setSortOrder(28).setCooldown(3)
            ...
            character("rin").setEnName("Rin").setZhName("凛").setEnTitle("Rookie Investigator").setZhTitle("新人调查员")
                    .setAttack(1).setDefense(1).setHealth(9).setSortOrder(29).setCooldown(3)
                    .setSkins(skin("harbour_holiday", "Harbour Holiday", "海湾假日", "sapphire"),
                            skin("winter_glow", "Winter Glow", "冬日暖意", "amethyst")),
            character("megas").setEnName("Megas").setZhName("梅加斯").setEnTitle("Mech Hero").setZhTitle("机械超人")
                    .setAttack(0).setDefense(2).setHealth(9).setSortOrder(30).setCooldown(3)
            ...
            character("zhao").setEnName("Zhao").setZhName("姬梦朝").setEnTitle("Fengshui Master").setZhTitle("风水师")
                    .setAttack(1).setDefense(1).setHealth(10).setSortOrder(31).setCooldown(3)
            ...
            character("teru").setEnName("Teru").setZhName("照").setEnTitle("Hierarch of Mikami").setZhTitle("三神御主")
                    .setAttack(2).setDefense(1).setHealth(9).setSortOrder(32).setCooldown(3)
                    .setSkins(skin("little_nurse", "Little Nurse", "小护士", "sapphire"),
                            skin("spellbinding_singer", "Spellbinding Singer", "魔旅歌姬", "platinum")),
            character("moses").setEnName("Moses").setZhName("摩西").setEnTitle("Gunsmith").setZhTitle("枪匠").setAttack(1)
                    .setDefense(1).setHealth(11).setSortOrder(33).setCooldown(2)
            ...
            character("mamushi").setEnName("Mamushi").setZhName("真梦梓").setEnTitle("Jiao of the Mire").setZhTitle("沼之蛟龙")
                    .setAttack(2).setDefense(1).setHealth(9).setSortOrder(34).setCooldown(3)
            ...
            character("ink_shadow").setEnName("Ink Shadow").setZhName("墨影").setEnTitle("Novice Hunter").setZhTitle("小猎手")
                    .setAttack(2).setDefense(1).setHealth(10).setSortOrder(35).setCooldown(3),
            character("bonnie").setEnName("Bonnie").setZhName("邦妮").setEnTitle("Poisoned Apple").setZhTitle("毒苹果")
                    .setAttack(2).setDefense(1).setHealth(9).setSortOrder(36).setCooldown(3)
            ...
            character("ling_ling").setEnName("Ling Ling").setZhName("铃铃").setEnTitle("Supernatural Forces").setZhTitle("怪力乱神")
                    .setAttack(2).setDefense(2).setHealth(10).setSortOrder(37).setCooldown(3),
            character("k_angel").setEnName("KAngel").setZhName("超天酱").setEnTitle("OMGKawaiiAngel").setZhTitle("超绝最可爱天使酱")
                    .setAttack(0).setDefense(1).setHealth(9).setImplicitBondSkin(false).setSortOrder(38).setCooldown(3)
                    .setSkins(skin("internet_angel", "Internet Angel", "网络主播", "platinum")),
            character("ame").setEnName("Ame").setZhName("糖糖").setEnTitle("Needy Girl").setZhTitle("主播女孩")
    ...
    public static class CharacterEntry {
        ...
        public boolean implicitBondSkin = true;
        public boolean skillSameIn2Mode;
        ...
        public CharacterEntry setAttack(int attack) {
            this.attack = attack;
            return this;
        }

        public CharacterEntry setDefense(int defense) {
            this.defense = defense;
            return this;
        }

        public CharacterEntry setHealth(int health) {
            this.health = health;
            return this;
        }

        public CharacterEntry setUnlockedByDefault(boolean unlockedByDefault) {
            this.unlockedByDefault = unlockedByDefault;
            return this;
        }

        public CharacterEntry setImplicitBondSkin(boolean implicitBondSkin) {
            this.implicitBondSkin = implicitBondSkin;
            return this;
        }

        public CharacterEntry setSkillSameIn2Mode(boolean skillSameIn2Mode) {
            this.skillSameIn2Mode = skillSameIn2Mode;
            return this;
        }
        ...
        public CharacterEntry setCooldown(int cooldown) {
            if (this.skillSameIn2Mode) {
                this.cooldown = cooldown;
                return this;
            } else {
                return this.setCooldown(cooldown, cooldown);
            }
        }

        public CharacterEntry setCooldown(int pvp, int pve) {
            if (!this.skillSameIn2Mode) {
