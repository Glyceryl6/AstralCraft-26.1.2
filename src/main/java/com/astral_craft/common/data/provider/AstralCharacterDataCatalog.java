...
public class AstralCharacterDataCatalog {
    ...
    public static final List<CharacterEntry> CHARACTERS = List.of(
            ...
            character("mimi", "Mimi", "米米", "Kanban Musume", "看板娘", 1, 1, 9, true, 17, 3, List.of(skin("slushie_express", "Slushie Express", "冰沙速递", "sapphire"), skin("transport_magic", "Transport Magic", "运输魔法", "amethyst"), skin("race_queen", "Race Queen", "赛车女郎", "emerald"))),
            character("z3000", "Z3000", "Z3000", "Waste-Collecting Robot", "垃圾箱", 1, 2, 10, false, 18, 4, List.of(skin("sky_explorer_assistant", "Sky Explorer Assistant", "天空探索助手", "amethyst"))),
            character("pandaman", "Pandaman", "潘大猛", "Human Chariot", "肉弹战车", 1, 0, 14, false, 19, 3, List.of()),
            character("lulu", "Lulu", "璐璐", "Slime Girl", "史莱姆", 2, 2, 9, false, 20, 3, List.of(skin("mimic", "Mimic", "拟态怪", "sapphire"), skin("sweet_trap", "Sweet Trap", "甜蜜陷阱", "amethyst"))),
            character("fen", "Fen", "枫", "Cheongsam Girl", "旗袍娘", 1, 0, 10, false, 21, 3, List.of(skin("maid_warrior", "Maid Warrior", "女仆战士", "sapphire"), skin("dragons_ascent", "Dragon's Ascent", "龙之腾跃", "amethyst"))),
            character("hai_qing", "Hai Qing", "蓝海晴", "Destiny Girl", "命运少女", 1, 1, 10, false, 22, 3, List.of(skin("stylish_grace", "Stylish Grace", "优雅风姿", "sapphire"), skin("costume_party", "Costume Party", "化装舞会", "amethyst"), skin("train_conductor", "Train Conductor", "列车长", "emerald"))),
            character("misaki", "Misaki", "美咲", "Katana Master", "太刀使", 0, 2, 9, false, 23, 3, List.of(skin("maid_warrior", "Maid Warrior", "女仆战士", "sapphire"), skin("ink_wash_waltz", "Ink-Wash Waltz", "墨韵圆舞", "amethyst"), skin("witchs_weapon", "Witch's Weapon", "魔女兵器", "amethyst"), skin("dragons_honor", "Dragon's Honor", "龙之荣耀", "ultimate"))),
            ...
            character("jasmine", "Jasmine", "茉莉", "Robot Maid", "家政机器人", 1, 0, 9, false, 25, 4, List.of(skin("coastal_surfer", "Coastal Surfer", "海岸冲浪者", "sapphire"), skin("festival_dress", "Festival Dress", "祭典礼装", "amethyst"), skin("kitchen_master", "Kitchen Master", "后厨能手", "amethyst"))),
            character("al", "A.L.", "阿尔", "Syndicate Prince", "暗区少主", 1, 1, 9, false, 26, 3, List.of(skin("ketchup_magic", "Ketchup Magic", "番茄酱魔法", "sapphire"))),
            character("luka", "Luka", "星魅琉华", "Midnight Flash", "午夜闪光", 1, 2, 9, false, 27, 3, List.of(skin("special_gift", "Special Gift", "特别礼物", "sapphire"), skin("fated_crossroads", "Fated Crossroads", "命运岔路", "amethyst"))),
            character("nancy_lu", "Nancy Lu", "南希露", "Cyber Phantom", "网络魅影", 1, 1, 9, false, 28, 3, List.of(skin("mealtime_magic", "Mealtime Magic", "用餐魔法", "sapphire"), skin("heatwave_shores", "Heatwave Shores", "热浪海岸", "amethyst"), skin("splendor_royale", "Splendor Royale", "雍容盛景", "ultimate"))),
            character("rin", "Rin", "凛", "Rookie Investigator", "新人调查员", 1, 1, 9, false, 29, 3, List.of(skin("harbour_holiday", "Harbour Holiday", "港湾假日", "sapphire"), skin("winter_glow", "Winter Glow", "冬日辉光", "amethyst"))),
